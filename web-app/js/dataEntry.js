...
//    alert("sdsds")
    ...
    if (semester) {
        $.ajax({
            ...
            data: {admissionYear:admissionYear,programCode: program,semester:semester,admissionSession:admissionSession},
            success: function (data) {
                if (data.status) {
                    $("#startAdmission_D").datepicker({ dateFormat: "dd/MM/yyyy" }).val(data.startDate)
                    $("#endAdmission_D").datepicker({ dateFormat: "dd/MM/yyyy" }).val(data.endDate)
               }
                else {
...
function enableAllOtherFields(t){
    var session=$(t).val()
    if(session!=''&& session!=null){
        $('#program').attr('disabled', false);
        $('#semesterList').attr('disabled', false);
        $('#startAdmission_D').attr('disabled', false);
        $('#endAdmission_D').attr('disabled', false);
        $('#admissionPeriodButton').attr('disabled', false);
        $('#admissionYear').attr('disabled', false);
    }
    else{
        $('#program').attr('disabled', true);
        $('#semesterList').attr('disabled', true);
        $('#startAdmission_D').attr('disabled', true);
        $('#endAdmission_D').attr('disabled', true);
        $('#admissionPeriodButton').attr('disabled', true);
        $('#admissionYear').attr('disabled', true);
    }
}
