...
<g:else>
    <div style="width: 100%;float: left; min-height: 1px; padding-right: 15px; padding-left: 15px;">
        ...
        <div style=" padding-top: 60px; padding-bottom: 50px;font-size: 18px; width: 100%;float: left;position: relative; min-height: 1px; padding-right: 15px; padding-left: 15px; margin-right: auto; margin-left: auto;clear: both;">
            ...
            <p class="view" id="paragraphView1"
               style="margin-bottom: 10px; padding-right: 15px; padding-left: 15px; margin-right: auto; margin-left: auto;clear: both;text-align: justify;">This is to certify that ${applicantName}, <g:if test="${male}">son</g:if><g:else>daughter</g:else> of ${parentName} was/ has been working as Guest Faculty / Part time Faculty in the Department of ${department} of Gauhati University Institute of Science and Technology, from ${joiningDate} till date. <g:if test="${male}">He</g:if><g:else>She</g:else> was/ is found to be sincere in discharging <g:if test="${male}">his</g:if><g:else>her</g:else> duties during that period.
            </p>
            <g:textArea name="paragraphEdit1" id="paragraphEdit1"
                        class="editCertificate col-sm-10  form-inline input-sm"
                        style="margin: 4px;display:none;"/>
            ...
            <p id="paragraphView2" class="view"
               style="margin-bottom: 10px; padding-right: 15px; padding-left: 15px; margin-right: auto; margin-left: auto;clear: both;text-align: justify;">I wish <g:if test="${male}">him</g:if><g:else>her</g:else> success in life.</p>
            <g:textArea name="paragraphEdit2" id="paragraphEdit2"
                        class="editCertificate col-sm-10 form-inline input-sm"
                        style="margin: 4px;display:none;"/>
            <p id="paragraphView3" class="view"
...
<input type="hidden" id="certificateType" name="certificateType" value="e"/>
