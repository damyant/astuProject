...
%{--Page for showing list of students pending for approval & view student details,
     According to student details user can Approve or reject student registration--}%
<html>
<head>
