...
<div id="main">
    <fieldset class="form">
        ...
        <g:form controller="postExamination" action="performGradeConvert" name="performGradeConvert" id="performGradeConvert">
            ...
            <table class="inner university-size-full-1-1">
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" class="university-button university-size-1-4" onclick="validate()" value="Convert"/></td>
                </tr>
            </table>
        </g:form>
        <div id="msgDiv"></div>
