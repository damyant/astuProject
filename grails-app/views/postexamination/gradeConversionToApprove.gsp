...
%{--interface for approving grades--}%
<html>
<head>
...
<div id="main">
    <fieldset class="form">
        <h3>Approve Grade Conversion</h3>
        ...
        <g:form controller="postExamination" action="performApproveGradeConvert" name="performApproveGradeConvert" id="performApproveGradeConvert">
            ...
            <table class="inner university-size-full-1-1">
                ...
                <tr>
                    <td></td>
                    <td><input type="button" class="university-button" value="Show Details" onclick="validate(),showEvaluatedMarksGrade()" id="evaluatedMarksShowDetails" disabled></td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td></td>
                    <td>
                        <input type="submit" style="text-align: center;visibility: hidden;" id="submitButton" class="university-button university-size-1-4" value="Approve"/>
                        <input type="button" style="text-align: center;visibility: hidden;" id="rejectButton" onclick="rejectGrades()" class="university-button university-size-1-4" value="Reject"/>
                    </td>
                </tr>
            </table>
        </g:form>
