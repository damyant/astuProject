    ...
    <div class="mainContent1" style="height: 300px">
        ...
        <div style="font-size: 20px;">
            <div class="body" style="padding: 5%;">
                ...
                <g:form method="post" controller="user" action="updatePwd" id="updatePwds" name="updatePwds">
                    <g:hiddenField name="identification" value="${params.id}"/>
                    <table id="resetPasswordContainer">
                        <tr>
                            ...
                            <td>
                                <input type="password" value="" name="newPwd" id="newPwd" class="university-size-1-1">
                            </td>
                        </tr>

                        <tr>
                            <td>Confirm Password</td>
                            <td><input type="password" value="" name="reNewPwd" id="reNewPwd" class="university-size-1-1"></td>
                        </tr>
                        <tr>
                            <td colspan="2">
