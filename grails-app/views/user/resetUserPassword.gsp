...
%{--In this page user can change it's own password--}%
<html>
<head>
    ...
    <fieldset class="form">
        ...
        <g:form controller="user" action="savePassword"  enctype="multipart/form-data"
            ...
            <table class="university-size-full-1-1 inner">
                ...
                <tr>
                    <td class="university-size-1-3"><label for="oldPwd"> Old Password<span class="university-obligatory">*</span></label></td>
                    <td class="university-size-2-3 ">
                        <input type="password" class="university-size-1-3" name="oldPwd" id="oldPwd"/>
