    ...
    <fieldset class="form">
        ...
        <g:form controller="feeDetails" action="payMiscFeeChallan" name="paychallanForStudyCenter" id="paychallanForStudyCenter">
            <table class="inner university-size-full-1-1" style="margin: auto">
                <thead>
                <tr>
                    <td class="university-size-1-4">Enter Pay-In-Slip Number</td>
                    <td class="university-size-1-4"><input type="text" name="searchChallanNo" id="searchChallanNo" value=""/></td>
                    <td class="university-size-1-4"><input type="button" value="Get Details" onclick="showMiscFeeListOfStudents()"/></td>
            ...
            <table id="studentPayList" class="university-size-full-1-1" style="visibility: hidden">
                <tr>
                    ...
                    <td class="university-size-2-3"><g:select name="paymentMode" class="university-size-1-2" id="paymentMode" optionKey="id" optionValue="paymentModeName" from="${paymentMode}" noSelection="['': ' Select Payment Mode']" /></td>
                    %{--onchange="loadPayInSlipDetails(this)"--}%
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <g:select name="bankName" class="university-size-1-2" id="bankNameForGU" optionKey="id"
                                  optionValue="bankName"  onchange="loadBranch(this)"
                                  from="${bankName}" noSelection="['': ' Select Bank']"/>
                    </td>
                </tr>
                <tr>
