...
<div id="main">
    ...
    <fieldset class="form">
        ...
        <g:form controller="bank" action="saveBank" method='post'  enctype="multipart/form-data" id="bankForm" name="bankForm">
            ...
            <td class="university-size-2-3 ">
                <input type="text" class="university-size-1-3" value="" name="bankName" id="bankName"/>
